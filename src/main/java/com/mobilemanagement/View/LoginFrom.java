...
public class LoginFrom extends javax.swing.JFrame {
    ...
    void login() {
        ...
        UserLogin User = UserDao.selectById(strUser);
        if (User == null) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 500, 410));

        setSize(new java.awt.Dimension(823, 408));
        setLocationRelativeTo(null);
